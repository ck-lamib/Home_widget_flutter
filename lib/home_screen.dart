...
const String iOSWidgetName = 'MyWidget';
const String androidWidgetName = 'MyWidget';
...
void updateHeadline(NewsArticle newHeadline) {
  ...
  HomeWidget.saveWidgetData<String>('filename', newHeadline.filename);
...
var getNewsStories = [
  ...
  NewsArticle(
    title: "title1",
    description: "If you are bad i am your dad",
  )
];
